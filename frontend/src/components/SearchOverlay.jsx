...
export function SearchOverlay({
  ...
  return <AnimatePresence>{isOpen && <div className="fixed inset-0 z-[200] flex items-start justify-center p-4 pt-[10vh]">{
    /* Backdrop */
  }<motion.div
  ...
  }<div className="p-4 flex flex-col gap-5 max-h-[320px] overflow-y-auto">{value.trim() === "" ? <>{
    /* Recent Searches */
  }{recentSearches.length > 0 && <div className="flex flex-col gap-2"><span className="text-[9px] font-mono text-text-muted uppercase tracking-wider">
