...
/** component_library.md §2: QuestionBar */
    ...
    <div className="w-full">
      ...
      <div
        ...
        className={cn(
          ...
          isFocused && !disabled
            ? 'border-[#5C6470] shadow-[0_0_0_1px_rgba(0,229,255,0.15)]'
            : 'border-fw-border',
      ...
      >
        {/* Context Label */}
        {contextLabel && (
          <span className="text-mono-meta font-mono text-text-muted mr-3 shrink-0 border-r border-fw-border pr-3">
            {contextLabel}
          </span>
        )}
        ...
        <button
          ...
          className={cn(
            ...
            value.trim() && !disabled
              ? 'text-drs-cyan hover:bg-drs-cyan/10'
              : 'text-text-muted'
          )}
        >
      ...
      {/* Character Count */}
      {value.length > 200 && (
        <p className="text-mono-meta font-mono text-text-muted mt-1 text-right">
          {value.length}/500
        </p>
      )}
    </div>
