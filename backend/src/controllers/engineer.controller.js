...
class EngineerController {
  static async query(req, res) {
    try {
      ...
      console.error('[EngineerController] Query handling error:', error.message, error.stack);
      const isProd = process.env.NODE_ENV === 'production';
      const safeMsg = isProd ? 'Internal server error processing engineering query' : error.message;
