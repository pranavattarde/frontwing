...
export function TeamCard({
  ...
  /><div className="pl-2">{
    /* Top Header */
  }<div className="flex justify-between items-start mb-3"><div><h4 className="text-text-primary text-sm font-semibold truncate max-w-[200px]">{team.name}</h4><div className="flex gap-2 mt-1">{team.drivers.map((d) => <button
    key={d.code}
    onClick={(e) => {
      e.stopPropagation();
